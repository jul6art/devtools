...
- **why** the page is being (re)written (`<reason>`), and which files moved (`<change path kind>`, one per
  file added, removed or changed since the last revision): start there;
