...
namespace Jul6Art\DevTools\Tests\Fixtures;

use Jul6Art\DevTools\Bridge\Symfony\DevToolsBundle;
...
{
    /**
     * @param array<string, mixed> $bundleConfig configuration for the "devtools" extension
    ...
    {
        return \sprintf('%s/jul6art-devtools-tests/%s/%s', sys_get_temp_dir(), $this->uniqueId, $this->environment);
    }

    private function configure(ContainerBuilder $container): void
    {
        $container->loadFromExtension('framework', [
            'secret' => 'jul6art-devtools-tests',
            'http_method_override' => false,
            'handle_all_throwables' => true,
            'php_errors' => ['log' => true],
        ]);

        $container->loadFromExtension('devtools', $this->bundleConfig);
    }
}
