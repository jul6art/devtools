...
final class CoverageThresholdsTest extends TestCase
{
    ...
    {
        self::assertSame(
            ['src/: 89.00 % of 200 statements covered, 90 % required.', 'src/Inspection/Freshness/: no statement in the report.', 'src/Tracking/: 99.00 % of 100 statements covered, 100 % required.'],
